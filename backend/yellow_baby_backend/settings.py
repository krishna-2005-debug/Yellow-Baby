...
DEBUG = config('DEBUG', default=False, cast=bool)  # Safe default: False in production
...
# ─── Cloudinary Media Storage (Persistent media on Render) ───────────────────
...
# ─── CORS ─────────────────────────────────────────────────────────────────────
# Kept as ALLOW_ALL for dev. Set CORS_ALLOW_ALL_ORIGINS=False in production.
...
# OTP_DEV_BYPASS: Enable ONLY in local dev. MUST be False in production.
OTP_DEV_BYPASS    = config('OTP_DEV_BYPASS', default=False, cast=bool)
